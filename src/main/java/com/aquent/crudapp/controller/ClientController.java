...
public class ClientController {
     ...
     *
     * @param clientId the ID of the person to edit
    ...
    public ModelAndView edit(@PathVariable Integer clientId) {
        ...
        mav.addObject("errors", new ArrayList<String>());
        mav.addObject("people", personService.listAClientsPeople(clientId));
        mav.addObject("possiblePeople" , personService.listPossiblePeople(clientId));
        return mav;
    }
     ...
     * On failure, the form is redisplayed with the validation errors.
     *
     * @param client populated form bean for the person
     ...
     *
     * @param client the ID of the client to be deleted
    ...
    @RequestMapping(value = "addPerson/{clientId}", method = RequestMethod.POST)
    public String addPerson(@PathVariable Integer clientId, @RequestParam Integer personToAdd) {
        ModelAndView mav = new ModelAndView("client/edit");
        
        personService.addClientToPerson(personToAdd, clientId);
        
         return "redirect:/client/edit/"+clientId.toString();
    }
